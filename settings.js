...
global.owner = process.env.OWNER_NUMBER  || '94724932148' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zIF0DSqT#r_SAgj1uwSDxJEjgNQ3MLIXLDhNZaI0naTA-2j_Uas4 ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94724932148" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'SHAN XD' ,
